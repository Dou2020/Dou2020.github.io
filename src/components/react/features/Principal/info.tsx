    ...
    <>
      <div className="flex items-center space-x-4 mb-4">
        ...
        <div>
          ...
          <p className="text-lg sm:text-xl md:text-2xl xl:text-4xl mb-4">FullStack Developer 🖥️, Data Scientist 👨‍💻</p>
        </div>
      </div>
      ...
      <p className="mt-4">¡Hola! Soy un apasionado programador con experiencia en desarrollo backend, frontend, despliegue en cloud <strong>(AWS, Azure)</strong> y ciencia de datos. Me encanta crear soluciones innovadoras y eficientes.</p>
