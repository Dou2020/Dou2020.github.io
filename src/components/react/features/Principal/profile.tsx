      ...
      <ul className="ml-6 space-y-4 list-none mb-8">
        ...
        <li>
          ...
          <ul className="ml-6 mt-2 flex flex-wrap gap-2 list-none">
            ...
            <li>
              <span className="inline-flex items-center gap-2 rounded-full bg-green-100 text-green-800 text-sm px-3 py-1 font-medium shadow">
                <svg className="w-4 h-4" fill="#007acc" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12 0C5.372 0 0 5.373 0 12s5.372 12 12 12 12-5.373 12-12S18.628 0 12 0zm1.812 17.535c0 .96-.552 1.54-1.44 1.54-.75 0-1.185-.39-1.41-.96l-1.41.84c.54 1.05 1.62 1.695 2.88 1.695 1.725 0 2.97-1.08 2.97-3.045v-6.21h-1.59v6.14zm-6.51-6.615c-.96 0-1.8.375-2.325 1.005l1.125 1.08c.285-.3.705-.555 1.2-.555.69 0 1.155.39 1.155 1.14v.15l-1.17.06c-1.515.09-2.4.705-2.4 2.01 0 1.17.945 1.935 2.22 1.935.9 0 1.545-.45 1.875-1.005.045.345.12.69.225.96h1.59c-.15-.465-.225-1.11-.225-1.665v-2.79c0-1.485-1.005-2.325-2.37-2.325zm.33 4.56c-.39 0-.66-.195-.66-.51 0-.48.555-.63 1.11-.66l.585-.03v.315c0 .705-.48.885-1.035.885z" />
                </svg>
                NestJS
              </span>
            </li>
            ...
            <li>
              <span className="inline-flex items-center gap-2 rounded-full bg-gray-200 text-gray-900 text-sm px-3 py-1 font-medium shadow">
                <svg className="w-4 h-4" fill="#512bd4" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <path d="M3 12c0-4.971 4.029-9 9-9s9 4.029 9 9-4.029 9-9 9S3 16.971 3 12z"/>
                </svg>
                .NET
              </span>
            </li>
            ...
            <li><span className="inline-flex items-center gap-2 rounded-full bg-blue-200 text-blue-900 text-sm px-3 py-1 font-medium shadow">🌐 RESTful</span></li>
        ...
        <li>
          ...
          <ul className="ml-6 mt-2 flex flex-wrap gap-2 list-none">
            ...
            <li><span className="inline-flex items-center gap-2 rounded-full bg-purple-100 text-purple-800 text-sm px-3 py-1 font-medium shadow">🅰️ Angular</span></li>
